...
var propiedades = {
  ...
  accion: null, // propiedad que inicia vacia
  digito: null, //para capturar el valor de la tecla clikeada
  ...
  calculadora: function (accion, digito) {
    switch (accion) {
      ...
      case "decimal":
        ...
        break;
      case "igual":
        propiedades.operaciones.innerHTML = eval(
          propiedades.operaciones.innerHTML
        );
...
metodos.inicio();
metodos.teclado();
console.log(propiedades.operaciones.Slice);
